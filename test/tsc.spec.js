...
describe('options parsing', function () {
    ...
    it('should combine all options into ngOptions', function () {
        var _a = tsc.readConfiguration('projectDir', 'basePath', { target: ts.ScriptTarget.ES6 }), parsed = _a.parsed, ngOptions = _a.ngOptions;
        expect(ngOptions).toEqual({
            ...
            configFilePath: 'projectDir/tsconfig.json'
        });
    });
});
